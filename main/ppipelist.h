...
int ppipelist_getbinary(const char* prefix, const char* name, uint8_t* src, size_t* size, size_t max);
int ppipelist_gettext(const char* prefix, const char* name, char* dst, size_t* size, size_t max);
int ppipelist_gethex(const char* prefix, const char* name, char* dst, size_t* size, size_t max);
